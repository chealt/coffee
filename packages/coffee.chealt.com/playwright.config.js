...
export default defineConfig({
  ...
  // The @auth tests share one user, and the passkeys tests identify their passkey as the
  // newest one on the list, so a concurrent registration would pick the wrong card
  workers: 1,
