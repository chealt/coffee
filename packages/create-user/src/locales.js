    ...
    content: ({ username, registrationCode }) => `
      ...
      <table class="content-item" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-bottom: 1px solid #eeeeee; margin-bottom: 20px;">
        <tr>
          ...
          <td width="40%" align="center" valign="middle" style="padding-bottom: 20px;">
            <img src="https://centralbeans.com/screenshots/features/profile-page.png" alt="Profile page" width="220" style="display: block; max-width: 100%; height: auto; border: 4px solid #272727; border-radius: 8px;" />
          </td>
        </tr>
      </table>
      ...
      <table class="content-item" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-bottom: 1px solid #eeeeee; margin-bottom: 20px;">
        <tr>
          <td width="40%" align="center" valign="middle" style="padding-bottom: 20px; padding-right: 15px;">
            <img src="https://centralbeans.com/screenshots/features/lists.png" alt="Collections page" width="220" style="display: block; max-width: 100%; height: auto; border: 4px solid #272727; border-radius: 8px;" />
          </td>
      ...
      <table class="content-item" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-bottom: 1px solid #eeeeee; margin-bottom: 20px;">
        <tr>
          ...
          <td width="40%" align="center" valign="middle" style="padding-bottom: 20px;">
            <img src="https://centralbeans.com/screenshots/features/details.png" alt="Coffee details page" width="220" style="display: block; max-width: 100%; height: auto; border: 4px solid #272727; border-radius: 8px;" />
          </td>
        </tr>
      </table>
      ...
      <table class="content-item" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-bottom: 1px solid #eeeeee; margin-bottom: 20px;">
        <tr>
          <td width="40%" align="center" valign="middle" style="padding-bottom: 20px; padding-right: 15px;">
            <img src="https://centralbeans.com/screenshots/features/review.png" alt="Coffee review page" width="220" style="display: block; max-width: 100%; height: auto; border: 4px solid #272727; border-radius: 8px;" />
          </td>
          <td width="60%" align="left" valign="middle" style="padding-bottom: 20px;">
    ...
    content: ({ username, registrationCode }) => `
      ...
      <table class="content-item" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-bottom: 1px solid #eeeeee; margin-bottom: 20px;">
        <tr>
          ...
          <td width="40%" align="center" valign="middle" style="padding-bottom: 20px;">
            <img src="https://centralbeans.com/screenshots/features/profile-page.png" alt="Strona profilu" width="220" style="display: block; max-width: 100%; height: auto; border: 4px solid #272727; border-radius: 8px;" />
          </td>
        </tr>
      </table>
      ...
      <table class="content-item" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-bottom: 1px solid #eeeeee; margin-bottom: 20px;">
        <tr>
          <td width="40%" align="center" valign="middle" style="padding-bottom: 20px; padding-right: 15px;">
            <img src="https://centralbeans.com/screenshots/features/lists.png" alt="Strona kolekcji" width="220" style="display: block; max-width: 100%; height: auto; border: 4px solid #272727; border-radius: 8px;" />
          </td>
          <td width="60%" align="left" valign="middle" style="padding-bottom: 20px;">
      ...
      <table class="content-item" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-bottom: 1px solid #eeeeee; margin-bottom: 20px;">
        <tr>
          ...
          <td width="40%" align="center" valign="middle" style="padding-bottom: 20px;">
            <img src="https://centralbeans.com/screenshots/features/details.png" alt="Strona szczegółów kawy" width="220" style="display: block; max-width: 100%; height: auto; border: 4px solid #272727; border-radius: 8px;" />
          </td>
        </tr>
      </table>
      ...
      <table class="content-item" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-bottom: 1px solid #eeeeee; margin-bottom: 20px;">
        <tr>
          <td width="40%" align="center" valign="middle" style="padding-bottom: 20px; padding-right: 15px;">
            <img src="https://centralbeans.com/screenshots/features/review.png" alt="Strona oceniania kawy" width="220" style="display: block; max-width: 100%; height: auto; border: 4px solid #272727; border-radius: 8px;" />
          </td>
          <td width="60%" align="left" valign="middle" style="padding-bottom: 20px;">
